...
cd /usr/bin
wget https://raw.githubusercontent.com/tdede914-creator/Red/refs/heads/ABSTRAK/bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
clear
wget https://raw.githubusercontent.com/tdede914-creator/Red/refs/heads/ABSTRAK/bot/kyt.zip
unzip kyt.zip
